...
class Player:
    ...
    def __init__(self, name: str, age: int, stamina=100):
        ...
        # self.need_sustenance = self.check_sustenance()
    ...
    @property
    def need_sustenance(self):  # DA VIDQ KOGA SE TRIGGERVA I KAK RABOTI
        return self.__stamina < 100  # True if self.stamina < 100 else False
